...
#define RTC_ADDRESS 0x68  // Assuming this is the correct address for DS3231
...
// Main program
uint8_t bcd_hour; // Variable to store BCD formatted hour
uint8_t bcd_min;
uint8_t bcd_sec;
void setup()
{
  bcd_min = decToBcd(11);
  bcd_sec = decToBcd(11);
  bcd_hour = decToBcd(11); // Assuming initial hour is 12
  ...
  I2C_WriteData(RTC_ADDRESS, SEC_REGISTER, (bcd_sec)); // Set initial seconds to 0
  I2C_WriteData(RTC_ADDRESS, MIN_REGISTER, (bcd_min)); // Set initial minutes to 0
  I2C_WriteData(RTC_ADDRESS, HOUR_REGISTER, (bcd_hour));         // Set initial hour (12 PM in this case)
